...
@implementation NSDate (ZCupertinoYankee)
...
- (NSDate *)z_endOfDay {
    ...
    return [[calendar dateByAddingComponents:components toDate:[self z_beginningOfDay] options:0] dateByAddingTimeInterval:-1];
}
...
- (NSDate *)z_endOfWeek {
    ...
    return [[calendar dateByAddingComponents:components toDate:[self z_beginningOfWeek] options:0] dateByAddingTimeInterval:-1];}
...
- (NSDate *)z_endOfMonth {
    ...
    return [[calendar dateByAddingComponents:components toDate:[self z_beginningOfMonth] options:0] dateByAddingTimeInterval:-1];
}
...
- (NSDate *)z_endOfYear {
    ...
    return [[calendar dateByAddingComponents:components toDate:[self z_beginningOfYear] options:0] dateByAddingTimeInterval:-1];
}
