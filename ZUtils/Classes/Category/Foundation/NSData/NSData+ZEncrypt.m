...
@implementation NSData (ZEncrypt)
static void z_FixKeyLengths(CCAlgorithm algorithm, NSMutableData * keyData, NSMutableData * ivData)
{
...
- (NSData*)z_encryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self z_CCCryptData:self algorithm:kCCAlgorithmAES128 operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief  利用AES解密据
 *
...
- (NSData*)z_decryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self z_CCCryptData:self algorithm:kCCAlgorithmAES128 operation:kCCDecrypt key:key iv:iv];
}
/**
 *  利用3DES加密数据
 *
...
- (NSData*)z_encryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self z_CCCryptData:self algorithm:kCCAlgorithm3DES operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief   利用3DES解密数据
 *
...
- (NSData*)z_decryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self z_CCCryptData:self algorithm:kCCAlgorithm3DES operation:kCCDecrypt key:key iv:iv];
}
...
- (NSData *)z_encryptedWithDESUsingKey:(NSString*)key andIV:(NSData*)iv{
    return [self z_CCCryptData:self algorithm:kCCAlgorithmDES operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief   利用DES解密数据
 *
...
- (NSData *)z_decryptedWithDESUsingKey:(NSString*)key andIV:(NSData*)iv{
    return [self z_CCCryptData:self algorithm:kCCAlgorithmDES operation:kCCDecrypt key:key iv:iv];
}
- (NSData *)z_CCCryptData:(NSData *)data
    ...
    z_FixKeyLengths(algorithm, keyData,ivData);
