...
- (NSData *)z_hmacMD5DataWithKey:(NSData *)key {
    return [self z_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}
/**
 *  @brief  sha1Data NSData
 *
...
{
    return [self z_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}
/**
 *  @brief  sha256Data NSData
 *
...
{
    return [self z_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
/**
 *  @brief  sha512Data NSData
 *
...
{
    return [self z_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}


- (NSData *)z_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
