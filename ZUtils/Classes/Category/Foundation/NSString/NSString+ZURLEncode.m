...
@implementation NSString (ZURLEncode)
/**
 *  @brief  urlEncode
 *
...
- (NSString *)z_urlEncode {
    return [self z_urlEncodeUsingEncoding:NSUTF8StringEncoding];
}
/**
 *  @brief  urlEncode
 *
...
- (NSString *)z_urlDecode {
    return [self z_urlDecodeUsingEncoding:NSUTF8StringEncoding];
}
/**
 *  @brief  urlDecode
 *
