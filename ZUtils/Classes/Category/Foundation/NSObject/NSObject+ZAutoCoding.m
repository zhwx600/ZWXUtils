...
@implementation NSObject (ZAutoCoding)
...
+ (instancetype)z_objectWithContentsOfFile:(NSString *)filePath
{
    //load the file
...
- (BOOL)z_writeToFile:(NSString *)filePath atomically:(BOOL)useAuxiliaryFile
{
...
+ (NSDictionary<NSString *, Class> *)z_codableProperties
{
    //deprecated
...
- (NSDictionary<NSString *, Class> *)z_codableProperties
{
    ...
    if (!codableProperties)
    {
        ...
        {
            [(NSMutableDictionary *)codableProperties addEntriesFromDictionary:[subclass z_codableProperties]];
...
- (NSDictionary<NSString *, id> *)z_dictionaryRepresentation
{
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    for (__unsafe_unretained NSString *key in self.z_codableProperties)
    {
...
- (void)z_setWithCoder:(NSCoder *)aDecoder
{
    BOOL secureAvailable = [aDecoder respondsToSelector:@selector(decodeObjectOfClass:forKey:)];
    BOOL secureSupported = [[self class] supportsSecureCoding];
    NSDictionary *properties = self.z_codableProperties;
...
{
    [self z_setWithCoder:aDecoder];
    return self;
}

- (void)encodeWithCoder:(NSCoder *)aCoder
{
    for (NSString *key in self.z_codableProperties)
    {
