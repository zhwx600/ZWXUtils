...
@interface NSObject (ZAutoCoding) <NSSecureCoding>
 ...
 * method instead.
 */
@property (nonatomic, readonly) NSDictionary<NSString *, Class> *z_codableProperties;
 ...
 */
@property (nonatomic, readonly) NSDictionary<NSString *, id> *z_dictionaryRepresentation;
 ...
 */
+ (nullable instancetype)z_objectWithContentsOfFile:(NSString *)path;
