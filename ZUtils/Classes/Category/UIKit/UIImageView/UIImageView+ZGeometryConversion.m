//
//  UIImageView+ZGeometryConversion.m
//  Pods
//
...
@implementation UIImageView (ZGeometryConversion)
...
- (CGRect)z_convertRectFromImage:(CGRect)imageRect {
    ...
    CGPoint viewTopLeft     = [self z_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self z_convertPointFromImage:imageBottomRight];
...
- (CGRect)z_convertRectFromView:(CGRect)viewRect {
    ...
    CGPoint imageTopLeft = [self z_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self z_convertPointFromView:viewBottomRight];
