 ...
 */
@interface UIImage (ZAnimateGIF)

/*
 UIImage *animation = [UIImage z_animatedImageWithAnimatedGIFData:theData];
 ...
 */
+ (UIImage *)z_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
 UIImage *image = [UIImagez_ animatedImageWithAnimatedGIFURL:theURL];
 ...
 */
+ (UIImage *)z_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
@end
