...
@implementation UILabel (ZFlickerNumber)
...
- (void)z_setNumber:(NSNumber *)number {
    [self z_setNumber:number format:nil];
}

//Method #2
- (void)z_setNumber:(NSNumber *)number formatter:(nullable NSNumberFormatter *)formatter {
    [self z_setNumber:number formatter:formatter attributes:nil];
}

//Method #3
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration {
    [self z_setNumber:number duration:duration format:nil attributes:nil];
}

//Method #4
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration formatter:(nullable NSNumberFormatter *)formatter{
    [self z_setNumber:number duration:duration formatter:formatter attributes:nil];
}

//Method #5
- (void)z_setNumber:(NSNumber *)number format:(nullable NSString *)formatStr {
    [self z_setNumber:number format:formatStr attributes:nil];
}

//Method #6
- (void)z_setNumber:(NSNumber *)number format:(nullable NSString *)formatStr formatter:(nullable NSNumberFormatter *)formatter {
    [self z_setNumber:number format:formatStr formatter:formatter attributes:nil];
}

//Method #7
- (void)z_setNumber:(NSNumber *)number attributes:(nullable id)attrs {
    [self z_setNumber:number format:nil attributes:attrs];
}

//Method #8
- (void)z_setNumber:(NSNumber *)number formatter:(nullable NSNumberFormatter *)formatter attributes:(nullable id)attrs {
    [self z_setNumber:number duration:1.0 format:nil numberFormatter:formatter attributes:attrs];
}

//Method #9
- (void)z_setNumber:(NSNumber *)number format:(nullable NSString *)formatStr attributes:(nullable id)attrs {
    [self z_setNumber:number duration:1.0 format:formatStr attributes:attrs];
}

//Method #10
- (void)z_setNumber:(NSNumber *)number format:(nullable NSString *)formatStr formatter:(nullable NSNumberFormatter *)formatter attributes:(nullable id)attrs {
    if(!formatter) {
        formatter = [self defaultFormatter];
    }
    [self z_setNumber:number duration:1.0 format:formatStr numberFormatter:formatter attributes:attrs];
}

//Method #11
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration format:(nullable NSString *)formatStr {
    [self z_setNumber:number duration:duration format:formatStr attributes:nil];
}

//Method #12
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration format:(nullable NSString *)formatStr formatter:(nullable NSNumberFormatter *)formatter {
    if(!formatter)
        formatter = [self defaultFormatter];
    [self z_setNumber:number duration:duration format:formatStr formatter:formatter];
}

//Method #13
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration attributes:(nullable id)attrs {
    [self z_setNumber:number duration:duration format:nil attributes:attrs];
}

//Method #14
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration formatter:(nullable NSNumberFormatter *)formatter attributes:(nullable id)attrs {
    if(!formatter)
        formatter = [self defaultFormatter];
    [self z_setNumber:number duration:duration format:nil numberFormatter:formatter attributes:attrs];
}

//Method #15
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration format:(nullable NSString *)formatStr attributes:(nullable id)attrs {
    [self z_setNumber:number duration:duration format:formatStr numberFormatter:nil attributes:attrs];
}

//Method #16
- (void)z_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration format:(nullable NSString *)formatStr numberFormatter:(nullable NSNumberFormatter *)formatter attributes:(nullable id)attrs {
    /**
