...
// Degree -> Rad
#define z_degToRad(x) (M_PI * (x) / 180.0)

@implementation UIView (ZVisuals)

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////

-(void)z_cornerRadius: (CGFloat)radius strokeSize: (CGFloat)size color: (UIColor *)color
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)z_setRoundedCorners:(UIRectCorner)corners radius:(CGFloat)radius {
...
-(void)z_addSubview: (UIView *)subview withTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
    [UIView beginAnimations: nil context: NULL];
    [UIView setAnimationDuration: duration];
         ...
         timingFunction: (CAMediaTimingFunction *)timingFunction
{
    ...
    rotation.toValue = [NSNumber numberWithFloat: z_degToRad(angle)];
